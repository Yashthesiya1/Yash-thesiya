export default function Hero() {
  return (
    <section className="space-y-8 pt-12 sm:pt-16">
      {/* Status badge */}
      <div className="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-gray-50 px-3 py-1 text-xs font-medium text-gray-600">
        <span className="inline-flex h-1.5 w-1.5 rounded-full bg-green-500" />
        Software Engineer at Openmalo
        <span className="text-gray-400">· 1 yr 5 mos</span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="max-w-xl text-sm leading-relaxed text-gray-500">
          ...
          <span className="font-semibold text-black">Openmalo</span>, shipping
      ...
      <div className="flex flex-wrap items-center gap-3">
        <a
          href="/resume.pdf"
          download
          className="inline-flex items-center gap-2 rounded-full border border-black bg-black px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-gray-800"
        >
          <svg
            className="h-4 w-4"
            fill="none"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-full border border-gray-300 px-5 py-2.5 text-sm font-medium text-black transition-colors hover:bg-gray-100"
        >
